...
* [Подведение итогов](#подведение-итогов)
  * [Что делать, если Nginx нужен в обоих средах?](#что-делать-если-nginx-нужен-в-обоих-средах)
...
### Что делать, если Nginx нужен в обоих средах?

В приведенном примере Nginx отсутствует в среде разработки.
Если по каким-то причинам он вам нужен в обоих средах,
